			...
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue2">			
				<div class="container-fluid">
					...
					<span id="found">
						...
						<label id="position" class="text-white h2 font-weight-bold">0</label><span class="text-white h2 font-weight-bold ml-1 mr-1">/</span><label id="total" class="text-white h2 font-weight-bold">0</label>
					</span>
